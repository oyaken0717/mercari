...
//	public String toItemList(Model model,Integer page) throws ParseException {
	public String toItemList(@Validated Page page, BindingResult result, Model model) throws ParseException {
		//■初回遷移時
		...
		List<Item> itemList = itemService.findAll(page.getNowPage());
